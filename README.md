🍎 Anor e-Commerce Project

Bu loyiha zamonaviy va tezkor elektron tijorat platformasi bo'lib, **FastAPI** (Backend) va **React** (Frontend) texnologiyalari yordamida yaratilgan.

🚀 Texnologiyalar
Loyihada quyidagi vositalardan foydalanilgan:
