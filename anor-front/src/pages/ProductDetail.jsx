...
const ProductDetail = () => {
  ...
  const images = product.images && product.images.length > 0
    ? product.images.map(img => img.image_url.startsWith('http') ? img.image_url : `https://anor-e-commerce.onrender.com/${img.image_url.replace(/^\/+/, '')}`)
                  ...
                  <div className="flex items-center mb-4">
                    <div className="relative mr-4 flex-shrink-0">
                      {seller.avatar?.image_url ? (
                        <img
                          src={seller.avatar.image_url.startsWith('http') ? seller.avatar.image_url : `https://anor-e-commerce.onrender.com/${seller.avatar.image_url.replace(/^\/+/, '')}`}
                          alt={seller.name}
